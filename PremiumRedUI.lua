...
function lib:Window(text, preset, closebind)
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        NotificationHold.BackgroundColor3 = Color3.fromRGB(100, 0, 0)
        ...
        NotificationHold.TextColor3 = Color3.fromRGB(100, 0, 0)
...
local ButtonIcon = Instance.new("ImageLabel") -- Image on right side
...
ButtonTitle.Position = UDim2.new(0.035, 0, 0, 0) -- Slightly adjusted left position
ButtonTitle.Size = UDim2.new(0, 280, 0, 42) -- Wider to prevent overlap
...
-- Right-aligned icon with proper spacing
...
-- Hover effects for both button and icon
Button.MouseEnter:Connect(function()
    ...
    TweenService:Create(
        ButtonIcon,
        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        {ImageColor3 = Color3.fromRGB(255, 255, 255)} -- Brighter on hover
    ):Play()
end)
...
Button.MouseLeave:Connect(function()
    ...
    TweenService:Create(
        ButtonIcon,
        TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        {ImageColor3 = Color3.fromRGB(200, 200, 200)} -- Return to normal
    ):Play()
end)
...
function tabcontent:Toggle(text, default, callback)
    ...
    Toggle.Text = ""
    Toggle.TextColor3 = Color3.fromRGB(100, 0, 0)
    ...
    ToggleBox.Position = UDim2.new(0.9, 0, 0.05, 0)
    ToggleBox.AnchorPoint = Vector2.new(0, 0) -- Make sure it's top-left
    ...
    BoxIcon.Image = "" -- Empty by default
    ...
    Toggle.MouseEnter:Connect(function()
        ...
        TweenService:Create(ToggleIcon, TweenInfo.new(.3, Enum.EasingStyle.Quad), {ImageColor3 = Color3.fromRGB(255, 255, 255)}):Play()
    end)

    Toggle.MouseLeave:Connect(function()
        TweenService:Create(Toggle, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(139, 0, 0)}):Play()
        TweenService:Create(ToggleIcon, TweenInfo.new(.2, Enum.EasingStyle.Quad), {ImageColor3 = Color3.fromRGB(200, 200, 200)}):Play()
    end)
    ...
    if default then
        ...
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            Slider.Text = ""
            Slider.TextColor3 = Color3.fromRGB(100, 0, 0)
            ...
            SlideFrame.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            Dropdown.Parent = Tab
            Dropdown.BackgroundColor3 = Color3.fromRGB(139, 0, 0)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            local OldToggleColor = Color3.fromRGB(100, 0, 0)
            local OldColor = Color3.fromRGB(100, 0, 0)
            ...
            Colorpicker.BackgroundColor3 = Color3.fromRGB(139, 0, 0)
            ...
            ConfirmBtn.Text = ""
            ConfirmBtn.TextColor3 = Color3.fromRGB(100, 0, 0)
            ...
            ColorpickerBtn.Text = ""
            ColorpickerBtn.TextColor3 = Color3.fromRGB(100, 0, 0)
            ...
            RainbowToggle.Text = ""
            RainbowToggle.TextColor3 = Color3.fromRGB(100, 0, 0)
            ...
            FrameRainbowToggle1.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
            ...
            FrameRainbowToggle2.BackgroundColor3 = Color3.fromRGB(139, 0, 0)
            ...
            FrameRainbowToggle3.BackgroundColor3 = Color3.fromRGB(139, 0, 0)
            ...
            FrameRainbowToggleCircle.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextboxFrame.BackgroundColor3 = Color3.fromRGB(160, 0, 0)
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            Bind.Name = "Bind"
            Bind.Parent = Tab
            Bind.BackgroundColor3 = Color3.fromRGB(139, 0, 0)
            Bind.Size = UDim2.new(0, 363, 0, 42)
            Bind.AutoButtonColor = false
            Bind.Font = Enum.Font.SourceSans
            Bind.Text = ""
            Bind.TextColor3 = Color3.fromRGB(100, 0, 0)
